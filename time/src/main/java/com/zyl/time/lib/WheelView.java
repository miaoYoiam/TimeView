...
import com.zyl.time.adapter.WheelAdapter;
...
public class WheelView extends View {
    ...
    public void setTextColorOut(int colorID) {
        textColorOut = getResources().getColor(colorID);
        paintOuterText.setColor(textColorOut);
        invalidate();
    }

    public void setDividerColor(int colorID) {
        dividerColor = getResources().getColor(colorID);
        paintIndicator.setColor(dividerColor);
        invalidate();
    }

    public void setTextColorCenter(int colorID) {
        textColorCenter = getResources().getColor(colorID);
